...
The `main` branch contains the source code and development artifacts of the project, including:

- Azure Databricks notebooks
- Sample employee datasets
- Generated output files
- Project documentation (README)
- Azure Data Factory source JSON files
- Linked Services
- Pipelines
- Datasets

This branch is intended for development, learning, and project understanding.

---

### adf_publish

The `adf_publish` branch is automatically generated by **Azure Data Factory** whenever the Data Factory is published.

It contains the deployment artifacts required to recreate the Data Factory in another Azure environment.

Contents include:

- ARMTemplateForFactory.json
- ARMTemplateParametersForFactory.json
- Factory deployment metadata

These templates can be imported into another Azure subscription to deploy the complete Azure Data Factory configuration.

> **Note:** The `adf_publish` branch does not contain Databricks notebooks or sample datasets. It only contains Azure Data Factory deployment templates.

---

## Deploying the Azure Data Factory Using the adf_publish Branch

If you want to recreate the Azure Data Factory:

1. Clone this repository.
2. Switch to the `adf_publish` branch.
3. Download the ARM templates.
4. In the Azure Portal, navigate to **Deploy a custom template**.
5. Upload:
   - `ARMTemplateForFactory.json`
   - `ARMTemplateParametersForFactory.json`
6. Provide your Azure resource names.
7. Deploy the template.
8. Update the Linked Services with your:
   - Azure Blob Storage
   - Azure Databricks Workspace
   - Personal Access Token
   - Databricks Cluster
9. Publish the Data Factory.
10. Trigger the pipeline.
---
## Important Note

This project is built using Azure cloud services.

To execute the complete pipeline, you must provision your own Azure resources and update the Linked Services accordingly.

Azure-specific resources such as Blob Storage, Azure Databricks, Personal Access Tokens, Unity Catalog, and Azure Data Factory are **not included** in this repository and must be configured within your own Azure subscription before running the pipeline.
